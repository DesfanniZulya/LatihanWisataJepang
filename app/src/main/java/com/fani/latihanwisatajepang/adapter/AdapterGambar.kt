package com.fani.latihanwisatajepang.adapter
...
import com.fani.latihanwisatajepang.R
    ...
    BaseAdapter()
{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null){
            view = LayoutInflater.from(context).inflate(R.layout.item_beranda, parent, false)
